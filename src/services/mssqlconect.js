...
// Consulta SQL
const consultaSQL = `
    SELECT ZAD_NUM, ZAD_CODUS,ZAD_NOME,ZAD_PROJET,ZAD_NUMTAR,ZAD_DESCR,ZAD_TIPO,ZAD_DTINI,ZAD_DTFIM, ZAD_ESFOR, A1_NREDUZ, ZAA_COD, ZAA_NOME, ZAA_VALHOR,A1_VALOR,A1_HRDEV, ZAC_FATURA,A1_PARCEIR
  FROM ZAD990 ZAD
